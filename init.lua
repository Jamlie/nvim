...
require('lazy').setup({
    ...
    { -- Fuzzy Finder (files, lsp, etc)
        ...
        config = function()
            ...
            map('<C-p>', builtin.find_files, '[F]ind [F]iles')
            map('<leader>f', '', 'Telescope')
            map('<leader>ff', builtin.find_files, '[F]ind [F]iles')
            map('<leader>fk', builtin.keymaps, '[F]ind [K]eymaps')
            map('<leader>fw', builtin.live_grep, '[F]ind [W]ord')
            ...
            map('<leader>fg', '', 'Git')
            map('<leader>fgb', builtin.git_branches, '[F]ind [G]it [B]ranches')
            map('<leader>fgf', builtin.buffers, '[F]ind [G]it [F]iles')
            map('<leader>fgc', builtin.buffers, '[F]ind [G]it [C]ommits')
            map('<leader>fgs', builtin.buffers, '[F]ind [G]it [S]tatus')
    ...
    --             -- have a well standardized coding style. You can add additional
    --             -- languages here or re-enable it for the disabled ones.
    --             local disable_filetypes = { typescript = true, javascript = true }
    --             if disable_filetypes[vim.bo[bufnr].filetype] then
    --                 return nil
    --             end
